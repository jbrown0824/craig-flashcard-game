...
exports.default = vue_1.default.extend({
  ...
  methods: {
    parseWord: function parseWord(word) {
      var text = word[0];
      var leftover = word.toString().substr(1);
      var regex = /([a-zA-Z])/gi;
      ...
      return text;
        ...
        var $ea1e55 = exports.default || module.exports;
      
      if (typeof $ea1e55 === 'function') {
        $ea1e55 = $ea1e55.options;
      }
    
        /* template */
        Object.assign($ea1e55, (function () {
          var render = function() {
  var _vm = this
  ...
  return _c("div", [
    _c(
      ...
      [
        ...
        _vm._v(" "),
        _c("button", { attrs: { type: "submit" } }, [_vm._v("Show Flash Card")])
      ]
    ),
    _vm._v(" "),
    _c(
    ...
    (function () {
      if (module.hot) {
        ...
        if (api.compatible) {
          module.hot.accept();
          if (!module.hot.data) {
            api.createRecord('$ea1e55', $ea1e55);
          } else {
            api.reload('$ea1e55', $ea1e55);
          }
        }
...
//# sourceMappingURL=/CraigFlasher.e31bb0bc.js.map